...
module.exports = (user) => {
    ...
    return {
        Subject: '[Résorption-bidonvilles] - Demande d’accès en attente depuis 3 jours',

        TextPart: `Bonjour,

        Une demande d’accès à la plateforme Résorption-bidonvilles est en attente depuis 3 jours. Nous vous rappelons qu’il est important d’y répondre rapidement.
