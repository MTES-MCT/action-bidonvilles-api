...
module.exports = () => ({
    ...
    Partager sur Facebook: https://www.facebook.com/sharer/sharer.php?u=https://resorption-bidonvilles.beta.gouv.fr/#/contact

    Partager sur Twitter: http://www.twitter.com/share?url=https://resorption-bidonvilles.beta.gouv.fr/#/contact
        
    Nous contacter par mail: mailto://contact@resorption-bidonvilles.beta.gouv.fr
                                    ...
                                    <td align="center" style="padding: 10px;">
                                        <table border="0" class="mobile-button" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <!--[if mso]>&nbsp;<![endif]-->
                                                    <a href="${frontUrl}/doc/guide_utilisateur_2021_02.pdf" target="_blank" style="16px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; font-weight:normal; text-align:center; background-color: #000091; text-decoration: none; border: none; -webkit-border-radius: 0px; -moz-border-radius: 0px; border-radius: 0px; display: inline-block;">
