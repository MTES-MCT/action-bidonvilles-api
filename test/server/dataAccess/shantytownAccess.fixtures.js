    ...
    findAll: {
        input: [
            ...
            },
            {
                ...
                rows: [
                    { fk_shantytown: 2, fk_social_origin: 1 },
                    { fk_shantytown: 2, fk_social_origin: 2 },
                ],
            },
            {
                ...
                rows: [
                    {
                        fk_shantytown: 2, description: 'Comment 1', created_at: builtDate, created_by: 1,
                    },
                    {
                        fk_shantytown: 2, description: 'Comment 2', created_at: builtDate, created_by: 1,
                    },
                ],
            },
            {
                ...
                rows: [
                    {
                        fk_shantytown: 2, fk_closing_solution: 1, number_of_people_affected: null, number_of_households_affected: null,
                    },
                    {
                        fk_shantytown: 2, fK_closing_solution: 2, number_of_people_affected: 25, number_of_households_affected: 10,
                    },
                ],
            },
        ],
        expectedOutput: [
            {
                ...
                latitude: 2.5,
                longitude: 1.0,
                address: baseShantytown.address,
                addressDetails: null,
